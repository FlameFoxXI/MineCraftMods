...
//				if ( thePlayer.username.equalsIgnoreCase(this.theBase.getOwnerName()))
				if ( thePlayer.getUniqueID().toString().equalsIgnoreCase(this.theBase.func_152113_b()))
				{
						...
						if (!this.petPathfinder.tryMoveToEntityLiving(this.thePlayer, this.speed))
						{
							if (this.theBase.getDistanceSqToEntity(this.thePlayer) >= 144.0D)
							{
								...
								for (int var4 = 0; var4 <= 4; ++var4)
								{
									...
									{
										if((var4 < 1 || var5 < 1 || var4 > 3 || var5 > 3) && World.doesBlockHaveSolidTopSurface(this.theBase.worldObj, var1 + var4, var3 - 1, var2 + var5) && !this.theBase.worldObj.getBlock(var1 + var4, var3, var2 + var5).isNormalCube() && !this.theBase.worldObj.getBlock(var1 + var4, var3 + 1, var2 + var5).isNormalCube())
										{
...
//		return var2 == null ? false : (!this.theBase.isTamed() && DocaTools.ofItem(var2, Item.bone) ? true : this.theBase.isFeedItem(var2));
		return var2 == null ? false : (!this.theBase.isTamed() && DocaTools.ofItem(var2, Items.bone) ? true : this.theBase.isFeedItem(var2));
	}
}
