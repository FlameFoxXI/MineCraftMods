...
public class DocaEntityAIDistance extends EntityAIBase
{
	...
	public boolean shouldExecute()
	{
		...
		Vec3 var2 = RandomPositionGenerator.findRandomTargetBlockAwayFrom(this.theEntity, (int)this.distanceFromEntity, 5, Vec3.createVectorHelper(this.closestLivingEntity.posX, this.closestLivingEntity.posY, this.closestLivingEntity.posZ));
