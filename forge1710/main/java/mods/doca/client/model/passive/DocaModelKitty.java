...
public class DocaModelKitty extends ModelBase
{
	...
	public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
	{
		...
		DocaEntityKitty var3 = (DocaEntityKitty)par1Entity;
		...
		else if (var3.getModelSize() == 1)
		{
			...
			this.ocelotHead.renderWithRotation(par7);
			this.ocelotBody.render(par7);
			this.ocelotBackLeftLeg.render(par7);
			this.ocelotBackRightLeg.render(par7);
			this.ocelotFrontLeftLeg.render(par7);
	...
	{
		DocaEntityKitty var5 = (DocaEntityKitty)par1EntityLivingBase;
		...
		this.ocelotHead.rotateAngleZ = var5.getInterestedAngle(par4) + var5.getShakeAngle(par4, 0.0F);
		this.ocelotTail.rotateAngleZ = var5.getShakeAngle(par4, -0.2F);
	}
