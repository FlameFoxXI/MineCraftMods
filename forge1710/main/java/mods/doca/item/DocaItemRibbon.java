...
//		super(par1);
    ...
    public boolean itemInteractionForEntity(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, EntityLivingBase par3EntityLivingBase)
    {
		if (!par2EntityPlayer.worldObj.isRemote)
		{
			...
			if (tmpNBTTagCompound != null && par3EntityLivingBase instanceof DocaEntityBase)
			{
				...
				if (tmpDocaEntityBase.func_152113_b().equalsIgnoreCase(par2EntityPlayer.getUniqueID().toString()) || DocaSet.Debug)
				{
	...
	public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
	{
		...
		if (par2EntityLivingBase instanceof EntityPlayer)
		{
			...
			if (tmpEntityPlayer.getUniqueID().toString() != null && !tmpEntityPlayer.getUniqueID().toString().equalsIgnoreCase(""))
			{
				tmpNBTTagCompound.setString(subOwnerName, tmpEntityPlayer.getUniqueID().toString());
				return true;
			}
		}
