...
public class CommonProxy
{
	...
	{
		DocaKeys tmp = DocaTools.getLoginUser(theBase.func_152113_b());
	...
	public boolean getOps(EntityPlayer player)
	{
		return DocaSet.func_AccessPermissionOPS ? 
				MinecraftServer.getServer().getConfigurationManager().func_152606_n().equals(player.getCommandSenderName().toLowerCase()) : false;
	}
