...
public class FFxiSlowFootedMod
{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		slowfootedItemHelMet = (new ItemSlowFooted(ItemArmor.ArmorMaterial.GOLD, renderId, 0)).setUnlocalizedName("helmetSlowFooted").setTextureName(textureFolder + "slowfeeted_helmet").setCreativeTab(CreativeTabs.tabCombat);
		slowfootedItemChest = (new ItemSlowFooted(ItemArmor.ArmorMaterial.GOLD, renderId, 1)).setUnlocalizedName("chestplateSlowFooted").setTextureName(textureFolder + "slowfeeted_chestplate").setCreativeTab(CreativeTabs.tabCombat);
		slowfootedItemLegs = (new ItemSlowFooted(ItemArmor.ArmorMaterial.GOLD, renderId, 2)).setUnlocalizedName("leggingsSlowFooted").setTextureName(textureFolder + "slowfeeted_leggings").setCreativeTab(CreativeTabs.tabCombat);
		slowfootedItemBoots = (new ItemSlowFooted(ItemArmor.ArmorMaterial.GOLD, renderId, 3)).setUnlocalizedName("bootsSlowFooted").setTextureName(textureFolder + "slowfeeted_boots").setCreativeTab(CreativeTabs.tabCombat);
	...
	private void addslowfootedItemRecipe()
	{
		GameRegistry.addRecipe(new ItemStack(slowfootedItemBoots, 1),
				new Object[] { "R R", "G G", "F F", 'R', Items.leather, 'G', Items.gold_ingot, 'F', Items.feather });
	}
}