...
public class FFxiSet
{
	...
	public static int blockFFxiBuildAssistId = 1240;
	...
	{
		blockFFxiBuildAssist = new BlockFFxiBuildAssist(blockFFxiBuildAssistId, Material.piston).setUnlocalizedName("FFxiBuildAssistScaffold")
				.setTextureName(image_AssetFolda + image_AssistScaffold).setCreativeTab(CreativeTabs.tabBlock);
