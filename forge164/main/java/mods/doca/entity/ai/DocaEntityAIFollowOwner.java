...
public class DocaEntityAIFollowOwner extends EntityAIBase
{
	...
	public DocaEntityAIFollowOwner(DocaEntityBase par1DocaEntityBase, double par2, float par3, float par4)
	{
