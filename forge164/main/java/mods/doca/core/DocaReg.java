...
public class DocaReg
{
	...
	public static boolean addPetSettingList(DocaSetTable entity)
	{
		if (!DocaReg.mapPetSettings.isEmpty()){
			for (int i = 0; i < DocaReg.mapPetSettings.size(); i++)
			{
				...
				{
					DocaTools.wrning("CoreSystemError : It has already been registered. pet no." + entity.memDocaPetNo);
					return false;
				}
			}
			for (int i = 0; i < DocaReg.mapPetSettings.size(); i++)
			{
				...
				{
					DocaTools.wrning("CoreSystemError : It has already been registered. pet Name." + entity.memDocaPetTypeDisp);
					return false;
				}
			}
		}
	...
	public static boolean addEntityUserSet(int no, String name, boolean use, int entityID, boolean growAge)
	{
		if (!DocaReg.mapPetSettings.isEmpty()){
			...
			DocaTools.wrning("CoreSystemError : No mach no and name RenderSetTable.");
			return false;
		}
		DocaTools.wrning("CoreSystemError : mapPetSettings is empty. for RenderSetTable.");
		return false;
	}
	...
	**************************************************************************************************************************/
	...
	public static int getPetNo(int no)
	{
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memDocaPetNo Error");
			return 0;
		}
	...
	public static String getTypeDisp(int no)
	{
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no)
		{
			DocaTools.wrning("memDocaPetTypeDisp Error");
			return "";
		}
	...
	public static String getTypeEntityName(int no)
	{
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no)
		{
			DocaTools.wrning("memDocaPetNameEntity Error");
			return "";
		}
	...
	public static String getTypeEntityNameUS(int no)
	{
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no)
		{
			DocaTools.wrning("memDocaPetNameEntityUS Error");
			return "";
		}
	...
	{
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memEntityType Error");
			return null;
		}
	...
	{
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memEntityRender Error");
			return null;
		}
	...
	public static boolean getUse(int no)
	{
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no)
		{
			DocaTools.wrning("memDocaUse Error");
			return false;
		}
	...
	{
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memDocaEntityId Error");
			return 0;
		}
	...
	public static boolean getGrowAge(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memDocaGrowAge Error");
			return false;
		}
	...
	public static Object getEggMakeItem0(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memEggMakeItem[0] Error");
			return false;
		}
	...
	public static Object getEggMakeItem1(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memEggMakeItem1 Error");
			return false;
		}
	...
	public static double getDocaSpeed(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memDocaSpeed Error");
	...
	public static Item getFeedItem(int no, int type){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no || 4 < type){
			DocaTools.wrning("memDocaFeedItem Error");
	...
	public static int getDocaTMax(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memDocaTextureMax Error");
			return 2;
		}
	...
	public static String getDocaTex(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memDocaTexture Error");
			return "";
		}
	...
	public static String getDocaTTame(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memDocaTextureTame Error");
			return "";
		}
	...
	public static String getDocaTCollar(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memDocaTextureCollar Error");
			return "";
		}
	...
	public static float getDocaWidth(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("memDocaPetWidth Error");
			return 0.6F;
		}
	...
	public static float getDocaHeightSize(int no, int type){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no || 3 < type){
			DocaTools.wrning("memDocaLivingSound Error");
			return 0.8F;
		}
	...
	public static String getTypeToName(int no){
		if (mapPetSettings.isEmpty() || mapPetSettings.size() < no){
			DocaTools.wrning("getTypeName Error");
			return "";
		}
	...
	public static String getModeTypeToName(int no){
		if (petModeLabelList.length < no){
			DocaTools.wrning("getModeTypeToName Error");
			return "";
		}
	...
	public static String getSizeTypeToName(int no){
		if (petSizeLabelList.length < no){
			DocaTools.wrning("getSizeTypeToName Error");
			return "";
		}
