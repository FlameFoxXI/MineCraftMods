...
public class DocaTileEntityChest extends TileEntity implements IInventory
{
	...
	{
		return this.isInvNameLocalized() ? this.customName : "container.DocaChest";
	}
	...
	public void updateEntity()
	{
		...
		{
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, DocaSet.blockDocaChest.blockID, 1, this.numUsingPlayers);
		}
