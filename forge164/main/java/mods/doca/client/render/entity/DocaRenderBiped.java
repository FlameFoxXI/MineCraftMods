...
public class DocaRenderBiped extends DocaRenderBase
{
	...
	protected void renderDocaItem(DocaEntityBiped par1DocaEntity, float par2)
	{
		...
		if (var4 != null  && var4.getItem() != null)
		{
			...
			if (DocaTools.newItem(var4) instanceof ItemBlock && RenderBlocks.renderItemIn3d(Block.blocksList[DocaTools.newItemID(var4)].getRenderType()))
			{
				var6 = 0.5F;
			...
			else if (DocaTools.ofItem(var4, Item.bow))
			{
				var6 = 0.625F;
