...
public class DocaGuiScreen extends GuiScreen
{
	...
	public void initGui()
	{
		...
		this.theGuiTextField = new GuiTextField(this.fontRendererObj, var2 + 90, var3 + 11, 90, 18);
...
//		String tmpColorStirng = ItemDye.dyeColorNames[(15 - this.theBase.getCollarColor())];
		String tmpColorStirng = ItemDye.field_150923_a[(15 - this.theBase.getCollarColor())];
//		int tmpColor = ItemDye.dyeColors[(15 - this.theBase.getCollarColor())];
		int tmpColor = ItemDye.field_150922_c[(15 - this.theBase.getCollarColor())];
		...
		this.fontRendererObj.drawString(StatCollector.translateToLocal("doca.gui.setting.title") +  ": ", var4, var5, 2039583);
		String var6 = "";
		this.theGuiTextField.drawTextBox();
		var6 = StatCollector.translateToLocal("doca.gui.setting.name") + ": ";
		this.fontRendererObj.drawString(var6, var4 + 60, var5 + 15, 2039583);
		var6 = StatCollector.translateToLocal("doca.gui.setting.texture") + ": " + tmpIndex;
		this.fontRendererObj.drawString(var6, var4 + 60, var5 + 38, 2039583);
		var6 = StatCollector.translateToLocal("doca.gui.setting.callor") + ": " + tmpColorStirng;
		this.fontRendererObj.drawString(var6, var4 + 60, var5 + 61, tmpColor);
		var6 = StatCollector.translateToLocal("doca.gui.setting.mode") + ": " + tmpMode;
		this.fontRendererObj.drawString(var6, var4 + 60, var5 + 84, 2039583);
		var6 = StatCollector.translateToLocal("doca.gui.setting.size") + ": " + tmpSizeText;
		this.fontRendererObj.drawString(var6, var4 + 60, var5 + 107, 2039583);
	}
