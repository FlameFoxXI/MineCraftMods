...
public class DocaEntityBunny extends DocaEntityBase
{
	public DocaEntityBunny(World par1World)
	{
		super(par1World);
		this.entityDocaString = DocaSet.PET_BUNNY;
...
//		return null;
	...
	********************************************************************************************/
	...
	{
		DocaEntityBunny var2 = new DocaEntityBunny(this.worldObj);
