...
public class DocaEntityDoggy extends DocaEntityBase
{
	public DocaFuncHowlingMoon funcHowlingMoon;
	public DocaFuncCreeperAlert funcCreeperAlert;

	public DocaEntityDoggy(World par1World)
	{
		super(par1World);
		this.entityDocaString = DocaSet.PET_DOGGY;
		...
		this.funcHowlingMoon = new DocaFuncHowlingMoon();
	...
	********************************************************************************************/
	...
	{
		return this.funcHowlingMoon.isHowling();
	}
...
//	protected void playStepSound(int par1, int par2, int par3, int par4)
	...
	{
		String tmpSound = this.rand.nextInt(2) == 0 ? (this.rand.nextInt(2) == 0 ? "mob.wolf.bark" : "mob.wolf.panting") : "";
		...
		if (this.isTamed())
		{
			...
			if (tmpLife < 7)
			{
				tmpSound = this.rand.nextInt(2) == 0 ? "mob.wolf.whine" : "";
			}

			if (this.funcCreeperAlert.getCreeperAlert(this, "mob.wolf.growl", this.getSoundVolume()))
			{
				tmpSound = "";
			}
		}
	...
	********************************************************************************************/
	...
	public void onLivingUpdate()
	{
		...
		this.funcHowlingMoon.onLivingUpdate(this, "mob.wolf.howl", this.getSoundVolume());
	}
	...
	********************************************************************************************/
	...
	{
		DocaEntityDoggy var2 = new DocaEntityDoggy(this.worldObj);
