...
public class DocaFuncChsetSearch
{
	...
	protected DocaTileEntityChest getTileEntityChestForBlock(World par1World, int par2, int par3, int par4)
	{
		...
		if (par1World.getBlock(par2, par3, par4) == DocaSet.blockDocaChest)
		{
			tmpTileEntityChest = (DocaTileEntityChest)par1World.getTileEntity(par2, par3, par4);
