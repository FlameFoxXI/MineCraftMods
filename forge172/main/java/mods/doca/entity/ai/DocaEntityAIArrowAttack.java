...
public class DocaEntityAIArrowAttack extends EntityAIBase
{
	private final EntityLiving entityHost;
	private final IRangedAttackMob rangedAttackEntityHost;
	private EntityLivingBase attackTarget;
	private IRangedAttackMob theAttackMob;
	private DocaEntityBiped theBiped;
	...
	public DocaEntityAIArrowAttack(DocaEntityBiped par1IRangedAttackMob, double par2, int par4, float par5)
	{
		this(par1IRangedAttackMob, par2, par4, par4, par5);
	}

	public DocaEntityAIArrowAttack(DocaEntityBiped par1IRangedAttackMob, double par2, int par4, int par5, float par6)
	{
		...
		else
		{
			...
			this.theBiped = (DocaEntityBiped)par1IRangedAttackMob;
	...
	public boolean shouldExecute()
	{
		...
		if (!this.theBiped.attackerMode.equalsIgnoreCase("range"))
		{
			return false;
		}
		else if (!this.theBiped.isAttackTargetCheck(entitylivingbase))
		{
			return false;
		}
		else
