...
public class FFxiSet
{
	...
	{
		itemWaterEraser = new ItemWaterEraser().setCreativeTab(CreativeTabs.tabTools).setTextureName("egg").setUnlocalizedName("FFxiWaterEraser");
	...
	public static void registerRecipeItems()
	{
		GameRegistry.addRecipe(new ItemStack(itemWaterEraser, 1),
				new Object[] { "PDP", "DED", "PDP", 'D', Items.diamond, 'E', Items.emerald, 'P', Items.ender_pearl }); 
	}
